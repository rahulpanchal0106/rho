import { Css, FileOpenRounded, GitHub,Html, Javascript, OpenInBrowser, OpenInFull, OpenInNew } from "@mui/icons-material"
import "./pinnedProjectCard.css"
import { isTypedArray } from "three/src/animation/AnimationUtils.js";
function PinnedProjectCard({name,subtitle,url,about,image,tech}){
    const techIcons = {
    ...
    return (
            ...
            <article className="pinnedcard" style={{
                backgroundImage:`url(${image})`
            }}>
                <div className="temporary_text">
                <a style={{color:"#EEEEEE"}} className="homepage" target="_blank" href={url}>
                    {name}   
                    <OpenInNew style={{fontSize:"0.6em", marginLeft: "5px"}}/>
                </a>                 
                </div>
                <div className="card_content">
                    ...
                    <p className="card_description">{about}</p>
                </div>
            </article>
...
export default PinnedProjectCard