...
function Projects(){
    return(
        <div className="projects" id="projects">
            ...
            <PinnedProjectCard tech={["expressjs","nodejs"]} name="PingIt" url="https://pingit-9cj7.onrender.com" about="I made this tool to keep my important servers active, and not getting a shut down during inactivity." subtitle="Escaping the server inactivity restrictions" image="/p1.jpg" />
            <PinnedProjectCard tech={["mongodb","expressjs","nodejs","html","css","js"]} name="ChatBison" url="https://chatbison.onrender.com" about="My first GenAI app, Learned so much stuff here." subtitle="A kind of ChatGPT clone" image="/p4.jpg" />
